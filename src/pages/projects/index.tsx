  ...
  return (
    <Layout title="프로젝트 등록">
      <div>
        ...
        <InputBaseStyle>
          <InputContainer>
            <InputDetailStyle type='text' placeholder="스터디에 사용할 언어/프레임워크는 어떤 것인가요?"/>
        ...
        <InputBaseStyle>
          <InputProjectContainer>
            <InputProjectTitle type='text' placeholder="프로젝트 제목을 입력해 주세요"/>
            <Horizon />
            <InputProjectContent placeholder="프로젝트 내용을 적어주세요"/>
            <ButtonBase>
